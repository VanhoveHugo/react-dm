  ...
  render() {
    return (
      <div>
        ...
        <button id="divide" onClick={this.props.operators} value="/">/</button>
        <button id="multiply" onClick={this.props.operators} value="x">x</button>
        ...
        <button id="subtract" onClick={this.props.operators} value="‑">‑</button>
        ...
        <button id="add" onClick={this.props.operators} value="+">+</button>
        ...
        <button className="jumbo" id="zero" onClick={this.props.numbers} value="0">0</button><button id="decimal" onClick={this.props.decimal} value=".">.</button>
  ...
  handleEvaluate() {
    if (!this.state.currentVal.includes('Limit')) {
      ...
      expression = expression
        ...
        .replace(/‑/g, '-')
        .replace('--', '+0+0+0+0+0+0+');
      let answer = Math.round(eval(expression));
      this.setState({
